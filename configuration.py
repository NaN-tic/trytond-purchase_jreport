...
__all_ = ['Configuration', 'PurchaseConfigurationCompany']
...
class Configuration:
    ...
    purchase_qty_decimal = fields.Function(fields.Boolean(
            'Purchase Qty Decimal', help='Show qty with or without decimals'),
...
class PurchaseConfigurationCompany(ModelSQL):
    'Purchase Configuration per Company'
    __name__ = 'purchase.configuration.company'

    company = fields.Many2One('company.company', 'Company', required=True,
        ondelete='CASCADE', select=True)
    purchase_qty_decimal = fields.Boolean('Purchase Qty Decimal')
